	...
	test( 'heading style', async ( { editor, page } ) => {
		...
		await expect(
			page
				...
				.getByRole( 'option', { name: 'Heading', selected: true } )
		).toBeVisible();
		await page.keyboard.press( 'Enter' );

		await page.keyboard.type( 'test' );
		await editor.canvas
			.locator( 'h2[data-type="core/heading"]' )
			.click();
		...
		await expect(
			page
				.getByLabel( 'Editor settings' )
				.locator( '.block-editor-block-styles' )
				.getByRole( 'button', { name: 'Thin Underline', exact: true } )
		).toBeVisible();
		await expect(
			page
				.getByLabel( 'Editor settings' )
				.locator( '.block-editor-block-styles' )
				.getByRole( 'button', { name: 'Thick Underline', exact: true } )
		).toBeVisible();
		await expect(
			page
				.getByLabel( 'Editor settings' )
				.locator( '.block-editor-block-styles' )
				.getByRole( 'button', { name: 'Two Color Underline', exact: true } )
		).toBeVisible();
		await expect(
			page
				.getByLabel( 'Editor settings' )
				.locator( '.block-editor-block-styles' )
				.getByRole( 'button', { name: 'Up Down Line', exact: true } )
		).toBeVisible();
		await expect(
			page
				.getByLabel( 'Editor settings' )
				.locator( '.block-editor-block-styles' )
				.getByRole( 'button', { name: 'Accent Line', exact: true } )
		).toBeVisible();
		await expect(
			page
				.getByLabel( 'Editor settings' )
				.locator( '.block-editor-block-styles' )
				.getByRole( 'button', { name: 'Kebab Line', exact: true } )
		).toBeVisible();
		await expect(
			page
				.getByLabel( 'Editor settings' )
				.locator( '.block-editor-block-styles' )
				.getByRole( 'button', { name: 'Single Box', exact: true } )
		).toBeVisible();
		await expect(
			page
				.getByLabel( 'Editor settings' )
				.locator( '.block-editor-block-styles' )
				.getByRole( 'button', { name: 'Double Box', exact: true } )
		).toBeVisible();
		await expect(
			page
				.getByLabel( 'Editor settings' )
				.locator( '.block-editor-block-styles' )
				.getByRole( 'button', { name: 'Left Accent Line', exact: true } )
		).toBeVisible();
		await expect(
			page
				.getByLabel( 'Editor settings' )
				.locator( '.block-editor-block-styles' )
				.getByRole( 'button', { name: 'Gradation Line', exact: true } )
		).toBeVisible();
		await expect(
			page
				.getByLabel( 'Editor settings' )
				.locator( '.block-editor-block-styles' )
				.getByRole( 'button', { name: 'Stripe Line', exact: true } )
		).toBeVisible();
		await expect(
			page
				.getByLabel( 'Editor settings' )
				.locator( '.block-editor-block-styles' )
				.getByRole( 'button', { name: 'Cross Box', exact: true } )
		).toBeVisible();
		await expect(
			page
				.getByLabel( 'Editor settings' )
				.locator( '.block-editor-block-styles' )
				.getByRole( 'button', { name: 'Brackets', exact: true } )
		).toBeVisible();
		await expect(
			page
				.getByLabel( 'Editor settings' )
				.locator( '.block-editor-block-styles' )
				.getByRole( 'button', { name: 'Japanese quotation marks', exact: true } )
		).toBeVisible();
...
<!-- /wp:heading -->`
	...
	test( 'separator style', async ( { editor, page } ) => {
		...
		await expect(
			page
				.locator( '.components-autocomplete__popover' )
				.getByRole( 'option', { name: 'Separator', selected: true } )
		).toBeVisible();
		await page.keyboard.press( 'Enter' );
		...
		await expect(
			page
				.getByLabel( 'Editor settings' )
				.locator( '.block-editor-block-styles' )
				.getByRole( 'button', { name: 'Thick line', exact: true } )
		).toBeVisible();
		await expect(
			page
				.getByLabel( 'Editor settings' )
				.locator( '.block-editor-block-styles' )
				.getByRole( 'button', { name: 'Dotted', exact: true } )
		).toBeVisible();
		await expect(
			page
				.getByLabel( 'Editor settings' )
				.locator( '.block-editor-block-styles' )
				.getByRole( 'button', { name: 'Asterisk', exact: true } )
		).toBeVisible();
	...
	test( 'button style', async ( { editor, page } ) => {
		...
		await expect(
			page
				.getByLabel( 'Editor settings' )
				.locator( '.block-editor-block-styles' )
				.getByRole( 'button', { name: 'Triangle Icon', exact: true } )
		).toBeVisible();
		await expect(
			page
				.getByLabel( 'Editor settings' )
				.locator( '.block-editor-block-styles' )
				.getByRole( 'button', { name: 'Blur', exact: true } )
		).toBeVisible();
		await expect(
			page
				.getByLabel( 'Editor settings' )
		...
		await expect(
			page
				.getByLabel( 'Editor settings' )
				.locator( '.block-editor-block-styles' )
				.getByRole( 'button', { name: 'Emboss', exact: true } )
		).toBeVisible();
	...
	test( 'list style', async ( { editor, page } ) => {
		...
		await expect(
			page
				.getByLabel( 'Editor settings' )
				.locator( '.block-editor-block-styles' )
				.getByRole( 'button', { name: 'No Style', exact: true } )
		).toBeVisible();
		await expect(
			page
				.getByLabel( 'Editor settings' )
				.locator( '.block-editor-block-styles' )
				.getByRole( 'button', { name: 'Inline', exact: true } )
		).toBeVisible();
		await expect(
			page
				.getByLabel( 'Editor settings' )
		...
		await expect(
			page
				.getByLabel( 'Editor settings' )
				.locator( '.block-editor-block-styles' )
				.getByRole( 'button', { name: 'Reference Mark', exact: true } )
		).toBeVisible();
		await expect(
			page
				.getByLabel( 'Editor settings' )
				.locator( '.block-editor-block-styles' )
				.getByRole( 'button', { name: 'Reference Mark (Inline)', exact: true } )
		).toBeVisible();
		await expect(
			page
				.getByLabel( 'Editor settings' )
		...
		await expect(
			page
				.getByLabel( 'Editor settings' )
				.locator( '.block-editor-block-styles' )
				.getByRole( 'button', { name: 'Icon', exact: true } )
		).toBeVisible();
	...
	test( 'image style', async ( { editor, page } ) => {
		...
		await expect(
			page
				.locator( '.components-autocomplete__popover' )
				.getByRole( 'option', { name: 'Image', selected: true } )
		).toBeVisible();
		await page.keyboard.press( 'Enter' );
		...
		const [ fileChooser ] = await Promise.all([
			...
			editor.canvas
				.locator( '.components-form-file-upload' )
		...
		await expect(
			page
				.getByLabel( 'Editor settings' )
				.locator( '.block-editor-block-styles' )
				.getByRole( 'button', { name: 'Round Corner', exact: true } )
		).toBeVisible();
		await expect(
			page
				.getByLabel( 'Editor settings' )
	...
	test( 'media-text style', async ( { editor, page } ) => {
		...
		await expect(
			page
				.locator( '.components-autocomplete__popover' )
				.getByRole( 'option', { name: 'Media & Text', selected: true } )
		).toBeVisible();
		await page.keyboard.press( 'Enter' );
		...
		await editor.canvas
			.locator( '.wp-block-media-text__content' )
		...
		await expect(
			page
				.getByLabel( 'Editor settings' )
				.locator( '.block-editor-block-styles' )
				.getByRole( 'button', { name: 'Round', exact: true } )
		).toBeVisible();
		await expect(
			page
				.getByLabel( 'Editor settings' )
	...
	test( 'table style', async ( { editor, page } ) => {
		...
		await expect(
			page
				.locator( '.components-autocomplete__popover' )
				.getByRole( 'option', { name: 'Table', selected: true } )
		).toBeVisible();
		await page.keyboard.press( 'Enter' );

		editor.canvas
			.getByRole( 'document', { name: 'Block: Table' } )
			.getByLabel( 'Column count' )
			.fill( '3' );
		await page.waitForTimeout(100);
		editor.canvas
			.getByRole( 'document', { name: 'Block: Table' } )
			.getByLabel( 'Row count' )
			.fill( '3' );
		editor.canvas
			.getByRole( 'document', { name: 'Block: Table' } )
		...
		for ( const i in Array(9).fill(0) ) {
			await editor.canvas
				.getByRole( 'document', { name: 'Block: Table', exact: true } )
		...
		await expect(
			page
				.getByLabel( 'Editor settings' )
				.locator( '.block-editor-block-styles' )
				.getByRole( 'button', { name: 'Dashed', exact: true } )
		).toBeVisible();
		await expect(
			page
				.getByLabel( 'Editor settings' )
